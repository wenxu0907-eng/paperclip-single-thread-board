...
export const backupRetentionPolicySchema = z.object({
  ...
  maxTotalCount: presetSchema(MAX_TOTAL_COUNT_PRESETS, "maxTotalCount").default(DEFAULT_BACKUP_RETENTION.maxTotalCount),
  maxTotalGb: presetSchema(MAX_TOTAL_GB_PRESETS, "maxTotalGb").default(DEFAULT_BACKUP_RETENTION.maxTotalGb),
});
