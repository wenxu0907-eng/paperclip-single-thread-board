...
export interface PluginInvocationContext {
  id: string;
  // COM-154: `null` = global (instance-wide) invocation, e.g. a gateway-ingress
  // worker→host call with no company scope. Mirrors the nullable
  // `WorkerHostCallContext.invocationScope` below.
